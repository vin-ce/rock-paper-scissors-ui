...
},{"mouse-proximity":2}],2:[function(require,module,exports){
!(function(a, b) {
	var c = 'mouseProximity';
	'function' == typeof define && define.amd
		? define([], b(c))
		: 'object' == typeof exports ? (module.exports = b(c)) : (a[c] = b(c));
})(this, function(a) {
	'use strict';
	function b(a, b) {
		var h = this;
		...
		(this.calcDists = function(a) {
			f(a), h.options.clear, i.forEach(h.calcDist);
		}),
			(this.calcDist = function(a, b, c) {
				(a.mouseProximity = Math.floor(
					Math.sqrt(
						Math.pow(d.x - (g(a).left + a.offsetWidth / 2), 2) +
							Math.pow(d.y - (g(a).top + a.offsetHeight / 2), 2)
					)
				)),
